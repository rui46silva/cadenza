...
export default function CookieConsent() {
  ...
  // Só mostra o banner se a publicidade estiver configurada e ainda não houver decisão.
  const adsConfigured = Boolean(process.env.NEXT_PUBLIC_ADSENSE_CLIENT);
    ...
    <div className="fixed inset-x-0 bottom-0 z-50 border-t border-black/10 dark:border-white/10 bg-white dark:bg-black">
      <div className="mx-auto max-w-4xl flex flex-col sm:flex-row items-start sm:items-center gap-3 px-4 py-3 text-sm">
        <p className="flex-1 text-black/70 dark:text-white/70">
          Usamos cookies para mostrar publicidade que ajuda a manter a Cadenza
          gratuita. Podes aceitar ou recusar — o site funciona na mesma.
        </p>
